...
//ARREGLO DE BOTONES
    ...
    this.ArregloBoton[4] = new Boton(400, 350, 100, 50); // Botón volver
    this.ArregloBoton[5] = new Boton(width / 2, height / 2, 120, 50); // Botón reiniciar  
    this.ArregloBoton[6] = new Boton(width / 2, 560, 100, 50); // Botón creditos

    //JUEGO
    this.Tiempo = 0;
    this.IndiceTiempo = 0;   
    this.premio = new CasaLadrillo(this.imagenes[24], width / 2, 50, 50);
    this.chanchito = new Cerdito(this.imagenes[23], 550, height - 80 / 2, 40);
